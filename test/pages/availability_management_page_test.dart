...
/// apart again.
void main() {
  // AvailabilityManagementPage isn't built for dependency injection, so
  // initState's load makes a real TokenStorage call. Stub the channel to
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      for (final entry in {
        FilledButton: ['Inserir', 'Editar', 'Excluir'],
